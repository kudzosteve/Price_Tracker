...
def scrap_amazon(the_url:str, target_price: float):
    ...
    try:
        ...
        product_name = driver.find_element(By.ID, value="titleSection").text
        price_dollars = driver.find_element(By.CLASS_NAME, value="a-price-whole").text
        price_cents = driver.find_element(By.CLASS_NAME, value="a-price-fraction").text
        current_price_str = price_dollars + '.' + price_cents
...
def main():
    for key in list(PRODUCTS.keys()):
        scrap_amazon(the_url=PRODUCTS[key]["the_url"],
